...
import liucj.utils.BigDecimalUtil;
import liucj.utils.DateTimeUtil;
import liucj.utils.FTPUtil;
import liucj.utils.PropertiesUtil;
import liucj.vo.OrderItemVo;
import liucj.vo.OrderProductVo;
import liucj.vo.OrderVo;
import liucj.vo.ShippingVo;
...
public class OrderServiceImpl implements IOrderService {
    ...
    public ServerResponse pay(Long orderNo, Integer userId, String path) {
        ...
        String subject = new StringBuffer().append("扫描支付，订单号").append(outTradeNo).toString();
    ...
    public ServerResponse aliCallback(Map<String, String> params) {
        ...
        Order order = orderMapper.selectByOrderNo(orderNo);
        if (order == null) {
            return ServerResponse.createByErrorMessage("非正确的订单,回调忽略");
        }
        if (order.getStatus() >= Const.OrderStatusEnum.PAID.getCode()) {
